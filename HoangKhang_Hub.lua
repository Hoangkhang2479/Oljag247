...
mainopens.Parent = mainopen
 ...
 loki.Image = "rbxassetid://131887642891731"
 ...
 local pos = UDim2.new(StartPosition.X.Scale, StartPosition.X.Offset + Fluxus.X, StartPosition.Y.Scale, StartPosition.Y.Offset + Fluxus.Y)
...
--------------------------------------------------------------------
local Library = Update:Window("HoangKhang_Hub ","")
------------------------------------------
